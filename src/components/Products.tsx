                ...
                <div key={index} className="bg-card border border-border rounded-lg overflow-hidden">
                  ...
                  {isOpen && (
                    <div className="px-6 pb-4">
                      <div className="grid md:grid-cols-2 gap-3 pt-4 border-t border-border">
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 text-white">
              <div className="space-y-4">
                ...
                <h3 className="text-2xl font-bold">Controle de Qualidade Rigoroso</h3>
                ...
                <a 
                  ...
                  className="inline-flex items-center justify-center h-11 px-8 bg-white text-orange-600 hover:bg-orange-50 transition-colors rounded-md font-medium"
                >
