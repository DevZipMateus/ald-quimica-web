  ...
  const productCategories = [
    {
      ...
      items: [
        ...
        "FENOLFTALEINA 1%",
        "FENOLFITALEINA P.A.",
        "FERRICIANETO DE POTÁSSIO P.A. ACS",
        "FERROCIANETO DE POTÁSSIO P.A.ACS",
        "FORMOLDEIDO 37% P.A.",
        "FOSFATO DE POTÁSSIO",
        "FOSFATO DE SÓDIO",
        "GLICERINA P.A.",
        ...
        "HIDRÓXIDO DE SÓDIO 50% (LÍQUIDO)",
        "HIDRÓXIDO DE SÓDIO (ESCAMA)",
        "HIDRÓXIDO DE SÓDIO P.A. (MICROPEROLAS)",
        "HIPOCLORITTO DE SÓDIO",
        ...
        "ÓXIDO DE CADMIO P.A.",
        "PAPEL FILTRO 60/60 MM",
        "PAPEL PH 0-14",
        "PAPEL PH 3,8 - 5,4",
        "PERMANGANATO DE POTÁSSIO",
        "PERÓXIDO DE HIDROGÊNIO",
        "PÓ DE ZINCO",
        "POLICLORETO DE ALUMINIO18%",
        "POLIMERO CATIÔNICO",
        "CIANETO DE PRATA",
        "SAL DE ROCHELLE",
        "Sulfato de Cobre",
        ...
        "TIOCIANATO DE POTÁSSIO P.A. ACS",
        "TIOCIANATO DE POTÁSSIO 0,1 MOL",
        "Ácidos em Geral"
      ]
    },
    {
